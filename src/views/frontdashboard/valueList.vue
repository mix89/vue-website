    ...
    <div class="">
      <div class="page_title_main">
        <el-menu
          ...
          @select="handleSelect"
        >
          <el-menu-item index="4" class="tab_item">仓单管理服务</el-menu-item>
            ...
            >
              ...
              <el-table-column prop="sysWhrNo" label="系统单号" width="178">
                <template slot-scope="scope">
                  ...
                  <!-- <el-button @click="toShow(scope.row)" type="text" size="small">{{scope.row.sysWhrNo}}</el-button> -->
                </template>
              </el-table-column>
              ...
              <el-table-column label="仓租起止时间" width="110">
                <template slot-scope="scope">
                  <!-- <span>{{scope.row.startTime | formartDate('') }} - {{scope.row.endTime | formartDate('') }}</span> -->
              ...
              <el-table-column prop="status" label="状态" width="110">
                <template slot-scope="scope">
                  <div v-for="(item,index) of statusList1" :key="index">
                    ...
                    <!-- <span v-else-if="index == scope.row.status">{{item}}</span> -->
                    <!-- <span v-else-if="index == scope.row.status">{{item}}</span> -->
                  </div>
                </template>
              </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleSelect(key) {
      ...
      // let newList = this.statusList.map((item,index)=>{
      //   if(index<4){
    ...
    init() {
      ...
      let processDetailCreateTime = null;
      if (this.select === "1") {
        ...
        processDetailCreateNickName = this.searchData;
        // if (processDetailCreateNickName) {
        //   processDetailCreateNickName = this.searchData;
        // } else {
        //   processDetailCreateName = this.searchData;
        // }
      }
      let data = {
        ...
        wName: wName,
        processDetailCreateNickName: processDetailCreateNickName,
