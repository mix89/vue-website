    ...
    <div class="page_container">
      <div class="page_title_main">
        <el-menu :default-active="''" class="el-menu-demo" mode="horizontal" @select="handleSelect">
          ...
          <el-menu-item index="5" class="tab_item">待评估</el-menu-item>
          ...
          >
           <template slot="empty">
            ...
            <el-table-column prop="status" label="状态" width="110">
              <template slot-scope="scope">
                  <span v-if="scope.row.status >= 6">已评估</span>
                  <span v-else-if="scope.row.status == 5">待评估</span>
              </template>
            </el-table-column>
