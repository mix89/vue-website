    ...
    <div class="page_container">
      <div class="page_title_main">
        <el-menu :default-active="''" class="el-menu-demo" mode="horizontal" @select="handleSelect">
          ...
          <!--<el-menu-item index="3" class="tab_item">暂存</el-menu-item>-->
          <el-menu-item index="1" class="tab_item">审核中</el-menu-item>
          <el-menu-item index="2" class="tab_item">评估中</el-menu-item>
          <el-menu-item index="8" class="tab_item">申请融资中</el-menu-item>
          <el-menu-item index="11" class="tab_item">进入智能合约</el-menu-item>
              ...
              <div style="float:right;margin-right:10px;">
                <div class="search_box">
                  ...
                  <search
                    ...
                    :value="select"
                    @calBack="searchCalBack"
                    @search="(data)=>{data == true?init():null}"
                  ></search>
          ...
          >
            ...
            <el-table-column prop="sysWhrNo" label="系统单号" width="178">
              <template slot-scope="scope">
                <!--<div v-if="scope.row.status == 2 || scope.row.status == 3 || scope.row.status == 7">-->
            ...
            <el-table-column label="操作" width="90">
              <template slot-scope="scope">
                <div>
                  ...
                  <!-- <div v-else-if="scope.row.status=='3' || scope.row.status=='7'">
                    <el-button
                      @click="toCheck(scope.row)"
                      type="text"
                      size="small"
