    ...
    <div>
        ...
        <div class="page_container">
            ...
            <div class="infoshow_box--cargo">
             ...
             <div class="infoshow_box">
                    <div class="infoshow_title">
                        <div class="infoshow_title_inner">评估价值及仓单总金额</div>
                    </div>
                    <div class="infoshow_body">
                        <div class="layout_infoshow">
                            <div class="infoshow_cell mt0">
                        ...
                        <div class="layout_infoshow border" style="min-height:30px">
                            <div class="infoshow_cell mt0">
                                <div class="infoshow_cell_title">
                                    <div class="infoshow_cell_title_inner">仓单总金额</div>
                                </div>
                    ...
                    <el-form :model="ruleForm4" ref="ruleForm4" :rules="rule4">
                        <div class="change_password_inner">
                            <div class="search_box inner_assess" style="margin-left:50px">
                                ...
                                >当 前 仓 单 评 估 价 值 为： {{ruleForm.costAmount}} 元</div>
                                <div
                ...
                <div v-show="stepState==='second'">
                    <div>
                        <div class="pledge_agreebox">
                            ...
                            <div class="protocol_title">仓单质押协议</div>
                            ...
                            <div class="fix">
                               ...
                               <div class="protocol_item"> 甲方（出质人）：</div>
                             ...
                             <div class="protocol_item">   法定代表人：</div>
                               <div class="protocol_item">  丙方（仓储方）：</div>
                                ...
                                <div class="protocol_text">
                                    ...
                                    >2.1 甲、丙方作为本协议中的出质人和仓储方，就本协议做出如下声明及保证：</div>
                                    <div
                                        class="protocol_item"
...
export default {
  ...
  methods: {
    ...
    submitApply() {
        ...
        this.stepActiveState = 0;
        this.ruleForm4.financeCycle =null
    ...
    next2() {
      let applyData = {};
      applyData.type = "1";
      applyData.relationId = this.ruleForm.whrId;
