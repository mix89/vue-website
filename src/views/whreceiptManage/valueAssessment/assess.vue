<template>
    <div>
        ...
        <div class="page_container">
                                ...
                                <div class="infoshow_cell">
                                    ...
                                    <div class="infoshow_cell_body minh60">
                                        <div style="margin-top:-12px;">
                                            <div
                                                v-for="(sub1,index1) in item.whreceiptAttachment"
                                                :key="index1"
                                            >
                                                <div class="flex mt10">
                                                    <div>
            ...
            <div class="infoshow_box">
                <div class="infoshow_title">
                    <div class="infoshow_title_inner">价值评估</div>
                </div>
                <div class="infoshow_body">
                    <el-form :model="ruleForm4" :rules="rules4" ref="ruleForm4">
                        <div class="layout_infoshow">
                            <div class="infoshow_cell mt0">
                                <div class="infoshow_cell_title">
                                    <div class="infoshow_cell_title_inner">货物价值</div>
                                </div>
                                <div class="infoshow_cell_body">
                                    <el-form-item label="" prop="price" class="custom-item">
                                        <el-input v-model="ruleForm4.price" placeholder="请输入货物价值"></el-input>(元)
                                    </el-form-item>
                                </div>
                            </div>
...
import { currency, area } from "@/utils/filters";
import {validateValuePrice} from "@/utils/validateRules"
...
export default {
  ...
  data() {
    return {
      ...
      rules4: {
        price: [{validator:validateValuePrice, trigger: ["blur","change"] }],
        desc:[{required:false,max:100,message:'字符长度在100个以内',trigger: ["blur","change"]}]
        // {validator:validateValueDesc,trigger: ["blur","change"] },
      },
      //文件上传
      uploadUrl: uploadUrl,
      //流程
  ...
  created() {
    ...
    // /api/auth/site/whreceipt/value/addInfoShow
    requestPost("/api/auth/site/whreceipt/value/addInfoShow", {
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        ...
        if (valid && this.attachMent) {
          //   #22
          let valueData = {};
          valueData.whrId = this.$route.query.whrId;
          valueData.costAmount = this.ruleForm4.price;
          valueData.remark = this.ruleForm4.remark;
          valueData.attachment = this.ruleForm4.attachment;
          valueData.attaName = this.ruleForm4.attaName;
          console.log(66666);
        ...
        //     });
          ...
          requestPost("/api/auth/site/whreceipt/cost", valueData).then(
            response => {

              if (response.data.code === 0) {
                this.$message.success("价值评估已提交");
                this.$router.push({ name: "valueAssessmentList" });
