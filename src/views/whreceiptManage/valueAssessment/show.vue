                                ...
                                <div class="infoshow_cell" style="margin-top:30px;">
                                    ...
                                    <div class="infoshow_cell_body">
                                        <div v-for="(subitem,index) in isMarkList" :key="index">
                                            <div v-if="subitem.key==item.isMark">{{subitem.value}}</div>
                                        </div>
                                        <!-- {{item.isMark}} -->
                                    </div>
                                </div>
...
export default {
  ...
  created() {
    ...
    requestPost("/api/auth/site/whreceipt/value/detailShow", {
