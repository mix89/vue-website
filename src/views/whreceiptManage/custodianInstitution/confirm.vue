        ...
        <div class="page_container">
            <div class="order_number_show mt10">
                <div class="fix">
                    ...
                    <span class="info_txt">待确认凭证</span>
                </div>
            </div>
...
export default {
  ...
  created() {
    ...
    //拉取仓单信息和货物信息
    requestPost("/api/auth/site/whreceipt/storage/addInfoShow", {
  ...
  methods: {
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        ...
        // #22
          let confirmData = {};
          confirmData.whrId = this.ruleForm.whrId;
        ...
        // "handleExplain":"可以准予通过",
          ...
          requestPost("/api/auth/site/whreceipt/keeping", confirmData)
            .then(response => {
              if (response.data.code === 0) {
