          ...
          <div class="infoshow_body">
            <div class="layout_infoshow">
              <div class="infoshow_cell mt0">
                ...
                <div class="infoshow_cell_body">{{ruleForm.pledgorType}}</div>
              </div>
              <div class="infoshow_cell mt30">
                <div class="infoshow_cell_title">
                    ...
                    <div v-show="stepState==='third'">
                        <div class="check_through">
                            ...
                            <div class="check_through_body">
                                <p class="mt30">请将相关买卖合同/协议等原件寄送至指定托管机构,</p>
  ...
  methods: {
    ...
    finalRefuse(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          let Checkdata = {};
          Checkdata.receId = this.ruleForm.receId;
        ...
        //   Checkdata.institutionId = this.ruleForm3.evalue;
          ...
          requestPost("/api/auth/site/receivable/examine", Checkdata)
            .then(response => {
  ...
  computed: {
   ...
   /*   pledgorType(){
       ...
       this.receTypeList.forEach((item)=>{
        ...
        return this.ruleForm.pledgorType
      })
