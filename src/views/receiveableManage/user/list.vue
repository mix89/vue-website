            ...
            <div class="fix">
              <div style="float:right;margin-right:10px;">
                <div class="search_box">
                  ...
                  <el-form-item label="状态" class="select-item w150" v-if="this.statusItem != '1' && this.statusItem != '2' && this.statusItem != '3'&& this.statusItem != '4'">
                    <div>
...
export default {
  ...
  data() {
    return {
      ...
      statusItemList:[1,2,3,4,6,7,8,9,10,11,12,13,14],
      statusItem:'',
      receId:null,
  ...
  methods: {
    ...
    handleSelect(key) {
      ...
      //已通过
        this.statusItemList = [4,6,7,8,9,10,11,12,13,14]
      } else if (key == "3") {
      //已驳回
        this.statusItemList = [3]
      }else {
        this.statusItemList = [1,2,3,4,6,7,8,9,10,11,12,13,14]
        this.optionList = [
          { key: '', value: "全部" },
          { key: 1, value: "暂存" },
          { key: 2, value: "待审核" },
    ...
    init() {
      ...
      let data = {
        ...
        statusList: this.status == null || this.status == ""? this.statusItemList:(this.status == 4 ? [4,6,7,8,9,10,11,12,13,14]:[this.status]),
        startTotalAmount:
