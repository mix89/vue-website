...
export function dealnumber(number) {
  // return (parseFloat(number).toPrecision(4).toFixed(2));
  // return (number.toFixed(4));
  //return (Math.round(number*100)/100);
  return ((number * 100).toFixed(2))
}

export function dealpercent(number) {
  // return (parseFloat(number).toPrecision(4).toFixed(2));
  // return (number.toFixed(4));
  //return (Math.round(number*100)/100);
...
export function formartDateTimeMinute(time) {
